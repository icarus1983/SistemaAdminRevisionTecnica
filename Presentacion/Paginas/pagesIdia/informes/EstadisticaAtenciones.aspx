<%@ Page Title="" Language="C#" MasterPageFile="~/Maestra.Master" AutoEventWireup="true" CodeBehind="EstadisticaAtenciones.aspx.cs" Inherits="Presentacion.Paginas.pagesIdia.informes.EstadisticaAtenciones" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>PRT | Informes</title>
</asp:Content>
               ...
               with font-awesome or any other icon font library -->
                ...
                <i class="right fas fa-angle-left"></i>
                            ...
                            <ul class="nav nav-treeview ">
                                <li class="nav-item ">
                                    <a href="EstadisticaAtenciones.aspx" class="nav-link active">
                                        <i class="far fa-circle nav-icon"></i>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Estadistica de atenciones</h1>
                        </div>
                        <!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active"><a href="EstadisticaAtenciones.aspx">Estadistica de atenciones</a></li>
                            </ol>
                        </div>
                        <!-- /.col -->
                    </div>
