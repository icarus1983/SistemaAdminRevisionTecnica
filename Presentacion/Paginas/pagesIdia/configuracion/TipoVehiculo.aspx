<%@ Page Title="" Language="C#" MasterPageFile="~/Maestra.Master" AutoEventWireup="true" CodeBehind="TipoVehiculo.aspx.cs" Inherits="Presentacion.Paginas.pagesIdia.configuracion.TipoVehiculo" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>PRT | Configuracion</title>
</asp:Content>
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                ...
                <i class="fas fa-angle-left right"></i>
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="TipoVehiculo.aspx" class="nav-link active">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Tipo de vehiculo</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="Marca.aspx" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Marca</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="Modelo.aspx" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Modelo</p>
                                    </a>
                                </li>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Tipo de vehiculo</h1>
                        </div>
                        <!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active"><a href="Marca.aspx">Tipo de vehiculo</a></li>
                            </ol>
                        </div>
                        <!-- /.col -->
                    </div>
