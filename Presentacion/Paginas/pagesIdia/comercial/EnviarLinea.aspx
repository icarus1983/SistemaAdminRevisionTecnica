<%@ Page Title="" Language="C#" MasterPageFile="~/Maestra.Master" AutoEventWireup="true" CodeBehind="EnviarLinea.aspx.cs" Inherits="Presentacion.Paginas.pagesIdia.comercial.EnviarLinea" %>
               ...
               with font-awesome or any other icon font library -->
                ...
                <i class="fas fa-angle-left right"></i>
                            ...
                            <ul class="nav nav-treeview" style="display: none;">
                                ...
                                <li class="nav-item">
                                    <a href="EnviarLinea.aspx" class="nav-link active">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Enviar a linea</p>
                                    </a>
                                </li>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="modal fade show" id="ver" runat="server" aria-modal="true" role="dialog" style="padding-right: 16px;">
                        <div class="modal-dialog modal-sm">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer justify-content-between">
                                    ...
                                    <div class="col-4">
                                        <asp:Button ID="btnAceptar" class="btn btn-info" runat="server" Text="Aceptar" OnClick="btnAceptar_Click" />
                                    </div>
                                </div>
                            </div>
                            <!-- /.modal-content -->
                    ...
                    <div class="modal-backdrop fade show" runat="server" id="ver1" style="display: none;"></div>
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Enviar a linea</h1>
                        </div>
                        <!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active"><a href="EnviarLinea.aspx">Enviar a linea</a></li>
                            </ol>
                        </div>
                        <!-- /.col -->
                    </div>
                            ...
                            <div class="col-4">
                                <div class="card card-info">
                                    <div class="card-header">
                                        <h3 class="card-title">Generar es_in</h3>
                                    </div>
                                    <div class="card-body">
                                        <div class="row">
                                            <label>Patente</label>
                                            <div class="input-group mb-3">
                                                ...
                                                <asp:TextBox ID="TextBox1" class="form-control" runat="server" placeholder="Patente"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <div class="row mb-3">
                                            ...
                                            <div class="col">
                                                <asp:Button ID="btnEsIn" class="btn btn-block btn-secondary" runat="server" Text="Generar" OnClick="btnEsIn_Click" />
                                            </div>
                                        </div>
                                    </div>
                                    <!-- /.card-body -->
