<%@ Page Title="" Language="C#" MasterPageFile="~/Maestra.Master" AutoEventWireup="true" CodeBehind="Editar.aspx.cs" Inherits="Presentacion.Paginas.pagesIdia.Usuarios.Editar" %>
                  ...
                  <span class="float-right text-sm text-danger"><i class="fas fa-star"></i></span>
                        ...
                        <a href="#" class="dropdown-item">
                            ...
                            <div class="media">
                                ...
                                <div class="media-body">
                                    <h3 class="dropdown-item-title">Admin
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                ...
                <i class="fas fa-angle-left right"></i>
                                    ...
                                    <ul class="nav nav-treeview">
                                        <li class="nav-item">
                                            <a href="Agregar.aspx" class="nav-link ">
                                                <i class="far fa-circle nav-icon"></i>
                                        ...
                                        <li class="nav-item">
                                            <a href="Detalle.aspx" class="nav-link active">
                                                <i class="fas fa-circle nav-icon"></i>
                                                <p>Editar usuario</p>
                                            </a>
                                        </li>
