<%@ Page Title="" Language="C#" MasterPageFile="~/Maestra.Master" AutoEventWireup="true" CodeBehind="Sucursal.aspx.cs" Inherits="Presentacion.Paginas.pagesIdia.sistema.Sucursal" %>
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                ...
                <i class="fas fa-angle-left right"></i>
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="CreacionAdmUsuarios.aspx" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Creacion admin</p>
                                    </a>
                                </li>
                                ...
                                <li class="nav-item">
                                    <a href="Sucursal.aspx" class="nav-link active">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Sucursal</p>
                                    </a>
                                </li>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Sucursal</h1>
                        </div>
                        <!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active"><a href="Sucursal.aspx">Sucursal</a></li>
                            </ol>
                        </div>
                        <!-- /.col -->
                    </div>
