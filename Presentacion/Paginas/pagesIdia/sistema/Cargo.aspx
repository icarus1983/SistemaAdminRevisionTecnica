<%@ Page Title="" Language="C#" MasterPageFile="~/Maestra.Master" AutoEventWireup="true" CodeBehind="Cargo.aspx.cs" Inherits="Presentacion.Paginas.pagesIdia.sistema.Cargo" %>
               ...
               with font-awesome or any other icon font library -->
                ...
                <i class="fas fa-angle-left right"></i>
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="Cargo.aspx" class="nav-link active">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Cargo</p>
                                    </a>
                                </li>
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active"><a href="Cargo.aspx">Cargo</a></li>
                            </ol>
                        </div>
                        <!-- /.col -->
                    </div>
