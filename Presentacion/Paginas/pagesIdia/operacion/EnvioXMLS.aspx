<%@ Page Title="" Language="C#" MasterPageFile="~/Maestra.Master" AutoEventWireup="true" CodeBehind="EnvioXMLS.aspx.cs" Inherits="Presentacion.Paginas.pagesIdia.operacion.EnvioXMLS" %>
               ...
               with font-awesome or any other icon font library -->
                ...
                <i class="fas fa-angle-left right"></i>
                            ...
                            <ul class="nav nav-treeview" style="display: none;">
                                ...
                                <li class="nav-item">
                                    <a href="EnvioXMLS.aspx" class="nav-link active">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Envio XMLS</p>
                                    </a>
                                </li>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Envio XMLS</h1>
                        </div>
                        <!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active"><a href="EnviarResumenAtencion.aspx">Envio XMLS</a></li>
                            </ol>
                        </div>
                        <!-- /.col -->
                    </div>
