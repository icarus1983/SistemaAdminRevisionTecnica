<%@ Page Title="" Language="C#" MasterPageFile="~/Maestra.Master" AutoEventWireup="true" CodeBehind="Departamento.aspx.cs" Inherits="Presentacion.Paginas.pagesIdia.sistema.Departamento" %>
               ...
               with font-awesome or any other icon font library -->
                ...
                <i class="fas fa-angle-left right"></i>
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="Departamento.aspx" class="nav-link activa">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Departamento</p>
                                    </a>
                                </li>
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active"><a href="Departamento.aspx">Departamento</a></li>
                            </ol>
                        </div>
                        <!-- /.col -->
                    </div>
