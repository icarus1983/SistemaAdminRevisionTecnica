<%@ Page Title="" Language="C#" MasterPageFile="~/Maestra.Master" AutoEventWireup="true" CodeBehind="EnviarResumenAtencion.aspx.cs" Inherits="Presentacion.Paginas.pagesIdia.operacion.EnviarResumenAtencion" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>PRT | Operacion</title>
</asp:Content>
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                ...
                <i class="fas fa-angle-left right"></i>
                            ...
                            <ul class="nav nav-treeview" style="display: none;">
                                <li class="nav-item">
                                    <a href="EvaluarRevisiones.aspx" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Evaluar revisiones</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="ImpresionCerificados.aspx" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Impresion de cerificados</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="EnvioXMLS.aspx" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Envio XMLS</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="EnviarResumenAtencion.aspx" class="nav-link active">
                                        <i class="far fa-circle nav-icon"></i>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Enviar resumen de atencion</h1>
                        </div>
                        <!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item ">Inicio</li>
                                <li class="breadcrumb-item ">Operacion</li>
                                <li class="breadcrumb-item active"><a href="EnviarResumenAtencion.aspx">Enviar resumen de atencion</a></li>
                            </ol>
                        </div>
                        <!-- /.col -->
                    </div>
