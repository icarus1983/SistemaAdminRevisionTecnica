<%@ Page Title="" Language="C#" MasterPageFile="~/Maestra.Master" AutoEventWireup="true" CodeBehind="Dashboard.aspx.cs" Inherits="Presentacion.Paginas.Dashboard" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>PRT | Inicio</title>
</asp:Content>
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item ">PRT</li>
                                <li class="breadcrumb-item active"><a href="Dashboard.aspx">Inicio </a></li>
                            </ol>
                        </div>
                        <!-- /.col -->
                    </div>
