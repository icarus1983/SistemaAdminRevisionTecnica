<%@ Page Title="" Language="C#" MasterPageFile="~/Maestra.Master" AutoEventWireup="true" CodeBehind="AnulacionCliente.aspx.cs" Inherits="Presentacion.Paginas.pagesIdia.comercial.AnulacionCliente" %>
               ...
               with font-awesome or any other icon font library -->
                ...
                <i class="fas fa-angle-left right"></i>
                            ...
                            <ul class="nav nav-treeview" style="display: none;">
                                ...
                                <li class="nav-item">
                                    <a href="AnulacionCliente.aspx" class="nav-link active">
                                        <i class="far fa-circle nav-icon"></i>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Anular cliente</h1>
                        </div>
                        <!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active"><a href="AnulacionCliente.aspx">Anulacion cliente</a></li>
                            </ol>
                        </div>
                        <!-- /.col -->
                    </div>
                                ...
                                <div class="modal-dialog modal-sm">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer justify-content-between">
                                            ...
                                            <div class="col-4">
                                                <asp:Button ID="btnAceptar" class="btn btn-info" runat="server" Text="Aceptar" Style="altura: 26px" OnClick="btnAceptar_Click" />
                                            </div>
                                        </div>
                                    </div>
                                    <!-- /.modal-content -->
                            ...
                            <div class="col-4">
                                <div class="card card-info">
                                    <div class="card-header">
                                        <h3 class="card-title">Anulacion de Cliente</h3>
                                    </div>
                                    <div class="card-body">
                                        <div class="row">
                                            <label>Patente</label>
                                    ...
                                    <div class="card-body">
                                        <div class="row mb-3">
                                            ...
                                            <div class="col">
                                                <asp:Button ID="btnAnular" class="btn btn-block btn-secondary" runat="server" Text="Anular" OnClick="btnAnular_Click" />
